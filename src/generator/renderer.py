...
class NaverHTMLRenderer:
    ...
    def add_naver_meta_tags(self, html: str, topic: str) -> str:
        ...
        return html
def render_html(title: str, hook: str, cases: List[str], procedure: List[str], 
                checklist_rows: List[str], cautions: List[str], cta: str, 
                sources: List[Dict[str, str]], hashtags: List[str]) -> str:
    """
    네이버 친화적 HTML 렌더링
    """
